public class ArrayDeque<T> {
    ...
    public void addFirst(T item) {
        ...
        if (size == this.data.length) {
            ...
            if (this.first < this.last) {
                if (this.first != -1) {
                    ...
                    System.arraycopy(this.data, this.last + 1, newData, newData.length - (this.size - this.last - 1), this.size - this.last - 1);
                ...
                System.arraycopy(this.data, 0, newData, 0, this.size - rightLength);
                System.arraycopy(this.data, this.first, newData, newData.length - rightLength, rightLength);
                this.first = newData.length - rightLength;
            }
            this.data = newData;
            if (this.first == 0) {
        ...
        if (this.first == -1) {
            ...
            this.first = index == 0 ? this.data.length - 1 : index - 1;
            this.data[this.first] = item;
            this.size++;
            return;
        }
        ...
        if (size == this.data.length) {
            ...
            if (this.first < this.last && this.first != -1)
                ...
                if (this.last == -1) {
                    ...
                    System.arraycopy(this.data, this.first, newData, newData.length - (this.size - this.first), this.size - this.first);
                ...
                int rightLength = this.size - this.last - 1;
                System.arraycopy(this.data, 0, newData, 0, this.last + 1);
                System.arraycopy(this.data, this.last + 1, newData, newData.length - rightLength, rightLength);
            }
            this.data = newData;
        ...
        if (this.first == -1) {
            ...
            if (this.data.length >= 16 && 1.0 * this.size / this.data.length < useRate) {
                ...
                if (this.last - this.size + 1 >= 0) {
                    ...
                    System.arraycopy(this.data, 0, newData, 0, this.last + 1);
                    System.arraycopy(this.data, index + 1, newData, newData.length - (this.size - this.last), this.size - this.last);
                }
                this.data = newData;
            }
        ...
        if (this.data.length >= 16 && 1.0 * this.size / this.data.length < useRate) {
            ...
            if (this.last == -1) {
                ...
                if (this.first + this.size - 1 <= this.data.length - 1) {
                    ...
                    System.arraycopy(this.data, this.first, newData, newData.length - (this.size - idx - 1), this.size - idx - 1);
                }
            } else {
                if (this.first < this.last) {
                    System.arraycopy(this.data, this.first, newData, 0, this.size);
                    ...
                    System.arraycopy(this.data, 0, newData, 0, this.last + 1);
                    System.arraycopy(this.data, this.first, newData, newData.length - (this.size - this.last - 1), this.size - this.last - 1);
                }
            }
            this.data = newData;
        }
        ...
        if (this.last == -1) {
            ...
            if (this.data.length >= 16 && 1.0 * this.size / this.data.length < useRate) {
                ...
                if (this.first + this.size - 1 <= this.data.length - 1) {
                    ...
                    System.arraycopy(this.data, this.first, newData, newData.length - (this.size - index), this.data.length - index);
                }
                this.data = newData;
            }
            return this.data[index];
        ...
        if (this.data.length >= 16 && 1.0 * this.size / this.data.length < useRate) {
            ...
            if (this.first == -1) {
                ...
                if (this.last - this.size + 1 >= 0) {
                    ...
                    System.arraycopy(this.data, 0, newData, 0, this.last + 1);
                    System.arraycopy(this.data, idx, newData, newData.length - (this.size - this.last - 1), this.size - this.last - 1);
                }
            } else {
                if (this.first < this.last) {
                    System.arraycopy(this.data, this.first, newData, 0, this.size);
